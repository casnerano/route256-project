...
func RegisterStockHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StockServer) error {
	...
	mux.Handle("GET", pattern_Stock_Info_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/route256.loms.api.v1.stock.Stock/Info", runtime.WithHTTPPathPattern("/v1/stock/info/{sku}"))
		if err != nil {
...
func RegisterStockHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StockClient) error {
	...
	mux.Handle("GET", pattern_Stock_Info_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/route256.loms.api.v1.stock.Stock/Info", runtime.WithHTTPPathPattern("/v1/stock/info/{sku}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
