...
const (
	Stock_Info_FullMethodName = "/route256.loms.api.v1.stock.Stock/Info"
)
...
func (c *stockClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Stock_Info_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Stock_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "route256.loms.api.v1.stock.Stock",
	...
	Metadata: "api/v1/stock_service.proto",
}
